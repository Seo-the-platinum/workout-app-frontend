    ...
    <div className='viewContainer' style={{backgroundImage: 'url(./images/add-workout.jpg)'}}>
      ...
      <form className='formContainer'>
        ...
        <div className='addFieldContainer'>
          ...
          <input id ='reps' name='reps' onChange={handleInput} type='number' value={data.reps}/>
        </div>
        <div className='addFieldContainer'>
        ...
        <div className='addFieldContainer'>
          ...
          <input id='weight' name='weight' onChange={handleInput} type='number' value={data.weight}/>
        </div>
        <div className='addFieldContainer'>
